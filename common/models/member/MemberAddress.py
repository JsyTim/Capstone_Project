...
class MemberAddress(db.Model):
    ...
    province_str = db.Column(db.String(10), nullable=False, server_default=db.FetchedValue())
    city_id = db.Column(db.Integer, nullable=False, server_default=db.FetchedValue())
    city_str = db.Column(db.String(10), nullable=False, server_default=db.FetchedValue())
    dist_id = db.Column(db.Integer, nullable=False, server_default=db.FetchedValue())
    dist_str = db.Column(db.String(10), nullable=False, server_default=db.FetchedValue())
